...
export default function CustomizationPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setMessages((prev) => [...prev, { role: 'bot', text: 'Error al procesar la solicitud.' }]);
    } finally {
  ...
  return (
    <div className="back font-sans min-h-screen" style={{ backgroundColor: bgColor }}>
      {showTermsModal && <TermsModal />}

      {/* Top Bar */}
      <div
        className="bg-white shadow-md w-full h-16 border flex items-center justify-between px-6 fixed top-0 left-0 z-10"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="max-w-4xl mx-auto rounded-lg" style={{ backgroundColor: '#11998e' }}>
            <div className="flex max-w justify-center mt-4">
              <h1 className="rounded-lg p-5 text-3xl font-bold text-white text-center">
                {welcomeText || 'Bienvenido al agente virtual'}
              </h1>
            </div>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div className="mt-6 border-1 border-gray-300 rounded-lg p-4 text-center">
              <video controls className="mx-auto max-w-full h-auto rounded shadow">
            ...
            {/* Text Input */}
            <h2 className="text-xl text-black font-semibold text-gray-800 mt-10 mb-4">
