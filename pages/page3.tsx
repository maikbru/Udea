...
export default function CustomizationPage() {
  ...
  try {
    const res = await fetch('https://2be40255792d.ngrok-free.app/chat', {
      method: 'POST',
 ...
 //guardar datos de la empresa
  ...
  return (
    ...
    >
      ...
      {chatVisible && (
      <div 
        className={`w-[360px] max-h-[80vh] bg-white rounded-xl shadow-xl mb-2 p-4 border border-gray-200 overflow-y-auto ${
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            {/* ✅ VIDEO PREVIEW AQUÍ */}
           <div className=" border-1 border-gray-300 rounded-lg p-4 text-center">
              <video
                controls
                className="mx-auto max-w-50 h-auto rounded shadow"
              >
          ...
          {/* Text Input */}
          <h2 className="text-xl text-black font-semibold text-gray-800 mt-1 mb-4">Conversación con el agente</h2>
          ...
          <div className="max-h-[400px] overflow-y-auto mb-4 bg-gray-50 text-black rounded p-4 border border-gray-200">
            {messages.map((msg, index) => (
              <div
                key={index}
                className={`mb-2 p-3 rounded-lg w-fit max-w-[95%] ${
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-grow px-1 py-2 border border-gray-300 text-black rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button
              onClick={handleAsk}
  ...
  <button
    className="w-16 h-16 rounded-full shadow-lg flex items-center justify-center bg-white border border-gray-300 hover:shadow-xl transition cursor-pointer"
